...
/*
 * Documentation:
 * Select — https://app.subframe.com/0890da2aa05a/library?component=Select_bb88f90b-8c43-4b73-9c2f-3558ce7838f3
 */
  ...
  return (
    ...
    >
      ...
      >
        ...
        <FeatherCheck className="hidden text-body font-body text-brand-600 group-hover/969e345b:hidden group-data-[state=checked]/969e345b:inline-flex" />
      </div>
    </SubframeCore.Select.Item>
  );
});
        ...
        >
          ...
          <div
            className={SubframeUtils.twClassNames(
              ...
              {
                "border border-solid border-neutral-100 bg-neutral-100 group-hover/bb88f90b:bg-neutral-100":
                  variant === "filled",
